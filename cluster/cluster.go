...
// gry: cpy from internal/mysqlcluster/defaults.go
...
// gry: 以下拷贝internal/mysqlcluster/mysqlcluster.go
...
// gry: GetMySQLVersion() 和 mysql.radondb.com 是改动的
...
// gry(TODO): 跟GetMySQLSemVer()一点点区别
...
// gry(TODO): presslabs的GetPodHostname()
...
// gry: controller/mysqlcluster/internal/syncer/statefullset.go: ensureVolumes()
...
// gry: 同上:ensureVolumeClaimTemplates()
...
func (c *Cluster) GetNameForResource(name utils.ResourceName) string {
	...
	default:
		// gry: utils.ServiceAccount就是
		return c.Name
	}
}

// gry: 参考internal/mysqlcluster/defaults.go:SetDefaults()里面的计算
// gry: controller/mysqlcluster/internal/syncer/statefullset.go里面的ensure系列函数?
