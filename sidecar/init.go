...
// gry:总体思路参考sidecar/appconf: RunConfigCommand
func runInitCommand(cfg *Config) error {
	var err error

	// gry: 参考的sidecar/appclone.go:RunCloneCommand()函数
	...
	// gry: 参考的sidecar/appconf.go,没啥好记录的
...
// gry: 优化？参考sidecar/appconf.go: getInitFileConfigs()函数
...
// gry: 优化,参考sidecar/applicable.go: initFileQuery()函数
